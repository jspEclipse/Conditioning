    ...
    return(
        ...
        <div className="bg-[#fff9df] max-w-4xl w-full p-6 md:p-10 mt-10 mb-10 border-l-4 border-b-4 border-[#3c3836] text-[#3c3836] leading-loose 2xl:max-w-7xl 2xl:min-h-[80.5rem]">
                ...
                <div>
                    ...
                    and decided fiddle around with the scroll a little bit for fun. I placed these rectangles as an example of 
              ...
              <div>
                ...
                to gain the user's trust and increase the likelyhood of a user to get scammed.
              </div>
            </div>
        </div>
    );
